...
# for setenv to survive reboot - http://www.dowdandassociates.com/blog/content/howto-set-an-environment-variable-in-mac-os-x-launchd-plist/
...
alias myip='ifconfig | grep -A 4 en0 | grep "inet " | cut -d " " -f 2' # myip: IP address of en0 (MacOS)
